...
!function(a, b, c) {
    var d = function(d, e) {
        "use strict";
        var f = {version: "1.0.4-TableTools2",clients: {},moviePath: "",nextId: 1,$: function(a) {
        ...
        return f.Client.prototype = {id: 0,ready: !1,movie: null,clipText: "",fileName: "",action: "copy",handCursorEnabled: !0,cssEffects: !0,handlers: null,sized: !1,glue: function(a, c) {
                this.domElement = f.$(a);
                var d = 99;
            ...
            TableTools = function(b, c) {
                ...
                return this.s = {that: this,dt: d,print: {saveStart: -1,saveLength: -1,saveScroll: -1,funcEnd: function() {
                    ...
                    if (b.sAction.match(/flash/)) {
                        ...
                        "text" == b.sAction ? this._fnTextConfig(d, b) : "div" == b.sAction ? this._fnTextConfig(d, b) : "collection" == b.sAction && (this._fnTextConfig(d, b), this._fnCollectionConfig(d, b));
                    ...
                    try {
                        ...
                        if (navigator.mimeTypes && navigator.mimeTypes["application/x-shockwave-flash"] !== c && navigator.mimeTypes["application/x-shockwave-flash"].enabledPlugin)
                            return !0
                    }
                    return !1
                    ...
                    if ("function" == typeof b) {
                        ...
                        for (c = 0, d = h; d > c; c++)
                            e.push(g[c].bVisible ? !0 : !1);
                    else if ("hidden" == b)
                        for (c = 0, d = h; d > c; c++)
                            e.push(g[c].bVisible ? !1 : !0);
                    else if ("sortable" == b)
                        for (c = 0, d = h; d > c; c++)
                            e.push(g[c].bSortable ? !0 : !1);
                    else
                        for (c = 0, d = h; d > c; c++)
                            e.push(!0);
                    return e

...
<script src="app/helper/functions.js"></script>
...
<ul class="submenu">
<?php
foreach ($sub["student_affairs"] as $key=>$val)
{?>
    <li class="">
						<a href="#" class="dropdown-toggle">
							               <i class="menu-icon fa fa-caret-right"></i> 
...
?>
    							<li class="">
                                                            <a href="?sec=sa&mod=<?php echo $vals["mod"]?>&action=<?php echo $vals["action"]?>">
									<i class="menu-icon fa fa-caret-right"></i>
<?php echo $keys?>
                                          </a>

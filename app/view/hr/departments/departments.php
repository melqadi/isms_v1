									...
									<!--<i class="ace-icon fa fa-angle-double-right"></i>-->
                                               ...
                                               ?>
                                                ...
                                                <a href="?sec=hr&mod=<?php echo $file_name ;?>&action=<?php echo $file_name ;?>_add"> 
                                                    <button class="btn btn-lg btn-success" >Add New Department </button>
                                                </a>
                                               <?php }?>
...
<div class="hidden-sm hidden-xs action-buttons">
 ...
 ?>
            <a class="blue" href="?sec=hr&mod=positions&action=positions_add&id_<?php echo $file_name ;?>=<?php echo $output["id_".$file_name] ;?>">
                <i title=" Add Positions" class="ace-icon glyphicon glyphicon-plus  bigger-130"></i>
            </a>
<?php
}                                        
 $edit=$ok["edit"];

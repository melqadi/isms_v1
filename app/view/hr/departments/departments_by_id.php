...
include $control.'departments_c.php';
...
<div class="form-group">
        <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Update Department </label>
    ...
    <input type="hidden"  name="id_<?php echo $file_x;  ?>" value="<?php echo $id_departments;?>">


<div class="clearfix form-actions">
        <div class="col-md-offset-3 col-md-9">
            <button id="val" class="btn btn-success " name="update" value="update" onclick='return confirm(<?php echo $confirm_add;?>)' type="submit">

...
?>
<form id="validate"  class="control-group form-horizontal" action="<?php echo $control;?>appointment_c.php" method="POST" >
    <input type="hidden" name="id_application" value="<?php echo $id_application;?>">
<!--/************************************.**************************************************************/-->
                           <?php
                                           echo    $addrelion=$ok["addrelion"];
                                               if($addrelion == "yes"){
                                               ?>
...
<div class="col-sm-9">
    <input value="<?php // echo $x_value["date"];?>" type="date" name="date" id="form-field-1"  class="col-xs-10 col-sm-5">
</div>
</div>-->
<?php
                                               }
...
<div class="col-sm-9">
    <input  id="noval"  value="<?php echo $x_value["national_application"];?>" type="number" name="national" id="form-field-1"  class="col-xs-10 col-sm-5">
</div>
</div>
<!--/*****************************marrital status*****************************************/-->
 <div class="form-group">

...
Employment Setup</a>
							...
							<li class="active"> <?php echo "Add Payroll Groups ";?></li>
						</ul><!-- /.breadcrumb -->
...
<div class="form-group">
        <label class="col-sm-3 control-label no-padding-right" for="form-field-1">Payroll Groups Name </label>
...
<div class="form-group">
        <label class="col-sm-3 control-label no-padding-right" for="form-field-1">Payroll Groups Code  </label>

        <div class="col-sm-9">
            <input type="text" name="code_<?php echo $file_x;  ?>" id="form-field-1"  class="col-xs-10 col-sm-5">
        </div>
</div>								

    <label for="form-field-select-2">Multiple (Ctrl+)</label>

    <select required name="categoru[]" class="form-control" id="form-field-select-2" multiple="multiple" size="5">
            <?php

...
Main Organization Languages								</small>-->
							</h1>
						</div><!-- /.page-header -->
                                                <?php
                                               $add=$ok["add"];
                                               ...
                                               ?>
                                                <a href="?sec=hr&mod=<?php echo $file_name ;?>&action=<?php echo $file_name ;?>_add"> 
                                                    <button class="btn btn-lg btn-success" >Add New Languages </button>
                                                </a>
                                                                                               <?php }?>
				...
				<?php
include $control.'languages_c.php';
...
<?php
                                               ...
                                               if($delete == "yes"){
?>
    <a class="red" onclick='return confirm(<?php echo $confirm_delete;?>)' href="<?php echo $control;?><?php echo $file_name ;?>_c.php?id_<?php echo $file_name ;?>=<?php echo $output['id_'.$file_name]; ?>&drop=1&name_<?php echo $file_name ;?>=<?php echo $output['name_'.$file_name]; ?>">

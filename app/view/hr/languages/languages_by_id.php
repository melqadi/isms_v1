<?php 
$id_languages=$_GET["id_languages"];
...
<div class="form-group">
        <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Languages Update </label>
    ...
    <input type="hidden"  name="id_<?php echo $file_x;  ?>" value="<?php echo $id_languages;?>">

...
die();
    ...
    Create Employee Profile
                                                ...
                                                <a href="?sec=hr&mod=<?php echo $file_name ;?>&action=<?php echo $file_name ;?>_add"> 
                                                    <button class="btn btn-lg btn-success" >Add New Profile </button>
                                                </a>
                                                    <!--/************************/-->
						<div class="row">
							<div class="col-xs-12">
...
<div class="hidden-sm hidden-xs action-buttons">
            <a class="blue" href="?sec=hr&mod=<?php echo $file_name ;?>&action=<?php echo $file_name ;?>_viwe&id_user=<?php echo $output["id_user"] ;?>">
                    <i class="ace-icon fa fa-search-plus bigger-130"></i>
            </a>

            <a class="green" href="?sec=hr&mod=<?php echo $file_name ;?>&action=<?php echo $file_name ;?>_by_id&id_user=<?php echo $output["id_user"] ;?>">
                    <i class="ace-icon fa fa-pencil bigger-130"></i>
            </a>

    <a class="red" onclick='return confirm(<?php echo $confirm_delete;?>)' href="<?php echo $control;?><?php echo $file_name ;?>_c.php?id_user=<?php echo $output['id_user']; ?>&drop=1">

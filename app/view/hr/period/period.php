...
<!--                    <i class="ace-icon fa fa-search-plus bigger-130"></i>-->
    ...
    <i class="ace-icon fa fa-bell icon-animated-bell"></i>
            ...
            <a class="green"  href="<?php echo $control;?>period_c.php?id_user=<?php echo $output["id_user"]; ?>&approve=1">
                    <i class="ace-icon glyphicon glyphicon-ok"></i>
            </a>

    <a class="red" onclick='return confirm(<?php echo $confirm_delete;?>)' href="<?php echo $control;?>period_c.php?id_user=<?php echo $output["id_user"]; ?>&drop=1">

									...
									<!--<i class="ace-icon fa fa-angle-double-right"></i>-->
                                               ...
                                               ?>
                                                <a href="?sec=hr&mod=<?php echo $file_name ;?>&action=<?php echo $file_name ;?>_add">
                                                    <button class="btn btn-lg btn-success" >Add New Category </button>
                                                </a>
                                               <?php }?>
                                                    <!--/************************/-->
						<div class="row">
...
<div class="hidden-sm hidden-xs action-buttons">
 ...
 ?>
            <a class="blue" href="?sec=hr&mod=departments&action=departments_add&id_<?php echo $file_name ;?>=<?php echo $output["id_".$file_name] ;?>">
<!--                    <i class="ace-icon fa fa-search-plus bigger-130"></i>-->
                    <i title=" Add Department" class="ace-icon glyphicon glyphicon-plus  bigger-130"></i>

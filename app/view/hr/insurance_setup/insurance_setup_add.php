...
<div class="form-group">
        ...
        <div class="col-sm-9">
            <input type="text" name="name_insurance" id="form-field-1" class="col-xs-10 col-sm-5">
        </div>
</div>								
<div class="form-group">
        ...
        <div class="col-sm-9">
            <input type="text" name="code_insurance" id="form-field-1"  class="col-xs-10 col-sm-5">
        </div>
</div>
...
<div class="radio" style="float: left;margin-left: 100px;font-size: 16px;
  ...
  ">
        <label>
            <input required name="insurance_from" value="basic" type="radio" class="ace">
...
<div class="form-group">
        ...
        <div class="col-sm-9">
            <input required type="number" name="value_employee" id="form-field-1"  class="col-xs-10 col-sm-5">
        </div>
</div>
...
<div class="radio" style="float: left;margin-left: 100px;font-size: 16px;
  ...
  ">
        <label>
            <input required name="type_employee" value="value" type="radio" class="ace">
...
<div class="clearfix form-actions">
        <div class="col-md-offset-3 col-md-9">
            <button id="val" class="btn btn-success " type="submit" name="add_value" value="add_value" onclick='return confirm(<?php echo $confirm_add;?>)'>
...
<div class="form-group">
        ...
        <div class="col-sm-9">
            <input required type="number" name="value_employer" id="form-field-1"  class="col-xs-10 col-sm-5">
        </div>
</div>
    <div class="form-group">
        <label  class="control-label bolder blue" style="float: left;margin-left: 10%;
...
<div class="radio" style="float: left;margin-left: 100px;font-size: 16px;
  ...
  ">
        <label>
            <input required name="type_employer" value="value" type="radio" class="ace">
                <span class="lbl"> Value
</span>
        </label>
</div>

<?php 
$id_positions=$_GET["id_positions"];
include $control.'positions_c.php';
...
<div class="form-group">
        <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Update Positions </label>
    ...
    <input type="hidden"  name="id_<?php echo $file_x;  ?>" value="<?php echo $id_positions;?>">

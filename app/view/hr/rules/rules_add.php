...
<div class="form-group">
<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Start Day  </label>

<div class="col-sm-9">
    <input type="time" name="start_day" id="form-field-1"  class="col-xs-10 col-sm-5">
</div>
</div>
    
<div class="col-xs-6  center">
<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Full Day Working Hours  </label>

<div class="knob-container inline">
    
    <input type="text" name="f" class="input-small knob" value="12" data-min="0" 
...
<div class="col-xs-6  center">
<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Half Day Working Hours  </label>

<div class="knob-container inline">
    <input type="text" name="h" class="input-small knob" value="12" data-min="0" 
       data-max="24" data-width="120" data-height="120" data-thickness=".2"
       data-fgcolor="#87B87F" data-displayprevious="true" data-anglearc="250" data-angleoffset="-125" />
</div>
</div> 

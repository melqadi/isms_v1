<?php 
$id_nationalities=$_GET["id_nationalities"];
include $control.'nationalities_c.php';
...
<div class="form-group">
        <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Update Nationalities </label>
    ...
    <input type="hidden"  name="id_<?php echo $file_x;  ?>" value="<?php echo $id_nationalities;?>">
